...
uses
  IniFiles,Windows,Class_FormMove,SysUtils, Classes,Controls, Forms, StdCtrls, Menus, ExtCtrls;
...
begin
  ...
  with FrmMain do begin
    sRGA:=tbRGACode.text;
    sRefresh:=strtointdef(tbRefreshRate.Text,-1);
    ...
    if (sRefresh<1) or (sRefresh = -1) then begin
